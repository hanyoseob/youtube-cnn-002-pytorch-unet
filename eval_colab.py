...
Original file is located at
    https://colab.research.google.com/drive/1tk8LulnVgYpKrbXIF1sAWl_KCUJTMM0h
"""
...
data_dir = './drive/My Drive/YouTube/002-pytorch-unet/dataset'
ckpt_dir = './drive/My Drive/YouTube/002-pytorch-unet/checkpoint'
log_dir = './drive/My Drive/YouTube/002-pytorch-unet/log'

result_dir = './drive/My Drive/YouTube/002-pytorch-unet/result'
...
dataset_test = Dataset(data_dir=os.path.join(data_dir, 'test'), nch=1, transform=transform)
...
# Commented out IPython magic to ensure Python compatibility.
# %tensorboard --logdir='./drive/My Drive/YouTube/002-pytorch-unet/log'